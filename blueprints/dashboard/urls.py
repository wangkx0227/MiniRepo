...
from .views import workbenches, projects, groups, merge_requests, todos, user_setting, secured_setting, \
    workbenches_overview, workbenches_repository, workbenches_analysis, workbenches_fragment
...
dashboard_bp.add_url_rule('/workbenches/repository', view_func=workbenches_repository, methods=['GET'])
