...
from .api.workbenches import AnnualContributionDataApi, DynamicTimelineDataApi, RepositoryDataApi
...
dashboard_api.add_resource(RepositoryDataApi, '/repository_type_search_data')
